...
data:
  ...
  bundledCode: "#line 1 \"Verify/AIZU_bigInt_modulo.test.cpp\"\n#define PROBLEM \"\
    https://onlinejudge.u-aizu.ac.jp/courses/library/6/NTL/2/NTL_2_E\"\n\n#line 1\
    ...
    \ 5 \"Verify/AIZU_bigInt_modulo.test.cpp\"\n\nint main() {\n  bigint A, B;\n \
    \ cin >> A >> B;\n  cout << A % B << endl;\n  return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: Verify/AIZU_bigInt_modulo.test.cpp
layout: document
redirect_from:
- /verify/Verify/AIZU_bigInt_modulo.test.cpp
- /verify/Verify/AIZU_bigInt_modulo.test.cpp.html
